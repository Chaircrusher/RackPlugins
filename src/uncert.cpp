...
UncertainWidget::UncertainWidget(Uncertain *module) : SequencerWidget(module)
{
	box.size = Vec(12 * RACK_GRID_WIDTH, RACK_GRID_HEIGHT);
	{
		...
		panel->setBackground(SVG::load(assetPlugin(pluginInstance, "res/modules/uncert.svg")));		
		addChild(panel);
	}
	...
	addInput(createPort<PJ301RPort>(Vec(lft_x, yncscape(107.334,8.255)), PortWidget::INPUT, module, Uncertain::CLOCK_FLUCT));
	addInput(createPort<PJ301BPort>(Vec(lft_x, yncscape(89.809, 8.255)), PortWidget::INPUT, module, Uncertain::IN_FLUCT));
	addParam(createParam<Davies1900hFixRedKnob>(Vec(center_x, yncscape(97.936, 9.525)), module, Uncertain::FLUCT_AMT, Uncertain::MIN_VOLTAGE, Uncertain::MAX_VOLTAGE, Uncertain::MIN_VOLTAGE));
	addOutput(createPort<PJ301GPort>(Vec(rgt_x, yncscape(98.571, 8.255)), PortWidget::OUTPUT, module, Uncertain::OUT_FLUCT));

	addInput(createPort<PJ301RPort>(Vec(lft_x, yncscape(68.885, 8.255)), PortWidget::INPUT, module, Uncertain::CLOCK_QUANTIZED));
	addInput(createPort<PJ301BPort>(Vec(lft_x, yncscape(51.360, 8.255)), PortWidget::INPUT, module, Uncertain::IN_QUANTIZED));
	ParamWidget *pw = createParam<Davies1900hFixWhiteKnob>(Vec(center_x, yncscape(59.487, 9.525)), module, Uncertain::QUANTIZED_AMT, 0.0, 5.0, 0.0);
	((Davies1900hKnob *)pw)->snap = true;
	addParam(pw);
	addOutput(createPort<PJ301GPort>(Vec(rgt_x, yncscape(68.885, 8.255)), PortWidget::OUTPUT, module, Uncertain::OUT_QUANTIZED_N1));
	addOutput(createPort<PJ301GPort>(Vec(rgt_x, yncscape(51.360, 8.255)), PortWidget::OUTPUT, module, Uncertain::OUT_QUANTIZED_2N));

	addInput(createPort<PJ301RPort>(Vec(lft_x, yncscape(28.407, 8.255)), PortWidget::INPUT, module, Uncertain::CLOCK_STORED));
	addInput(createPort<PJ301BPort>(Vec(lft_x, yncscape(10.882, 8.255)), PortWidget::INPUT, module, Uncertain::IN_STORED));
	addInput(createPort<PJ301BPort>(Vec(mm2px(23.591), yncscape(10.882, 8.255)), PortWidget::INPUT, module, Uncertain::IN_CURVEAMP));
	addParam(createParam<Davies1900hFixBlackKnob>(Vec(mm2px(16.285), yncscape(19.010, 9.525)), module, Uncertain::STORED_AMT, Uncertain::MIN_VOLTAGE + 2.5, Uncertain::MAX_VOLTAGE - 2.5, 5.0));
	addParam(createParam<Davies1900hFixBlackKnob>(Vec(mm2px(35.150), yncscape(19.010, 9.525)), module, Uncertain::CURVEAMP_AMT, 0.0,2.0,1.0));
	addOutput(createPort<PJ301GPort>(Vec(rgt_x, yncscape(28.407, 8.255)), PortWidget::OUTPUT, module, Uncertain::OUT_STORED_RND));
	addOutput(createPort<PJ301GPort>(Vec(rgt_x, yncscape(10.882, 8.255)), PortWidget::OUTPUT, module, Uncertain::OUT_STORED_BELL));
}
